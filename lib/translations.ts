export const translations = {
  en: {
   ...
   careerSubtitle: "CAREER AT INNOSTUDIO",
   careerSubtitle2: "At INNOSTUDIO, we're not just looking for a barber. We're looking for a personality who wants to build a brand, improve and work in a modern environment with high service standards.",
  ...
  sk: {
    ...
    careerSubtitle: "KARIÉRA V INNOSTUDIO",
    careerSubtitle2: "V INNOSTUDIO nehľadáme len barbera. Hľadáme osobnosť, ktorá chce budovať značku, zlepšovať sa a pracovať v modernom prostredí s vysokým štandardom služieb.",
